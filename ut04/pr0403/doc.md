...
def buscar_elemento(): 
    ...
    nombre_buscado = input("Introduce tu nombre") 

    try: 

        print(nombres.index(nombre_buscado)) 
...
def nombres_anteriores(nombre): 

    return nombres[:nombres.index(nombre):] 

     

print(nombres_anteriores("Juan")) 
```
...
def numero_misma_longitud(nombre): 

    cuenta = 0 

    for nombreRecorrido in nombres: 

        if len(nombreRecorrido) == len(nombre): 
...
print(numero_misma_longitud("Juan")) 
```
...
def nombres_cortos(): 
    ...
    for nombreRecorrido in nombres: 
        ...
        if len(nombreRecorrido) <= 4: 

            nombresCortos.append(nombreRecorrido) 
...
def contar_vocales(): 
	...
	contenidoCompleto = "".join(nombres).lower() 

	print("a "+ str(contenidoCompleto.count("a"))) 

	print("e "+ str(contenidoCompleto.count("e"))) 

	print("i "+ str(contenidoCompleto.count("i"))) 

	print("o "+ str(contenidoCompleto.count("o"))) 

	print("u "+ str(contenidoCompleto.count("u"))) 
...
def contar_letras(): 
	...
	for caracter in contenidoCompleto: 
...
```python
listaPalabras = ["coche", "casa", "coche", "coche"] 

def veces_en_lista(palabra): 

    return listaPalabras.count(palabra) 

     

print(veces_en_lista("coche")) 
```
...
print(eliminar_duplicados(listaPalabras)) 
```
